  ...
  categories: [
    {
      title: 'Bodas',
      href: '/bodas',
      cloudinaryPublicId: 'v1784484576/klipstudio/site/figma/home-v2/card-bodas-jpg.webp',
      localMobileSrc: '',
      localDesktopSrc: '',
    },
    {
      title: 'Cumpleaños',
      href: '/cumpleanos',
      cloudinaryPublicId: 'v1784484577/klipstudio/site/figma/home-v2/card-cumpleanos-jpg.webp',
      localMobileSrc: '',
      localDesktopSrc: '',
    },
    {
      title: 'Quinceañeros',
      href: '/quinceaneros',
      cloudinaryPublicId: 'v1784484650/klipstudio/site/figma/home-v2/card-quinceaneros-jpg.webp',
      localMobileSrc: '',
      localDesktopSrc: '',
    },
    {
      ...
      href: '/fotos-estudio',
      cloudinaryPublicId: 'v1784484581/klipstudio/site/figma/home-v2/card-sesiones-jpg.webp',
      localMobileSrc: '',
      localDesktopSrc: '',
    },
    {
      title: 'Publicidad',
      href: '/publicidad',
      cloudinaryPublicId: 'v1784484578/klipstudio/site/figma/home-v2/card-publicidad-jpg.webp',
      localMobileSrc: '',
      localDesktopSrc: '',
    },
  ],
...
export const homeLandingContent = {
  ...
  footer: {
    ...
    handles: [
      { icon: 'Facebook', text: '@klipstudiocreativo', href: 'https://www.facebook.com/profile.php?id=61589857529373' },
      { icon: 'TikTok', text: '@klipstudiocreativo', href: 'https://www.tiktok.com/@klipstudiocreativo' },
      { icon: 'Instagram', text: '@klipstudiocreativo', href: 'https://www.instagram.com/klipstudiocreativo' },
    ],
  },
};
